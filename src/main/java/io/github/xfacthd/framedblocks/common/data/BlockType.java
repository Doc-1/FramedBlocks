...
public enum BlockType implements IBlockType
{
    ...
    FRAMED_STACKED_SLOPE_EDGE                       ( true, false,  true,  true,  true,  true, false, ConTexMode.FULL_FACE, Outline.CUSTOM, ElevatedSlopeEdgeShapes.INSTANCE),
    ...
    FRAMED_INNER_CORNER_SLOPE_EDGE                  (false, false,  true,  true,  true, false, false, ConTexMode.FULL_EDGE, Outline.CUSTOM, CornerSlopeEdgeShapes.INNER),
    ...
    FRAMED_ELEVATED_INNER_CORNER_SLOPE_EDGE         ( true, false,  true,  true,  true, false, false, ConTexMode.FULL_FACE, Outline.CUSTOM, ElevatedCornerSlopeEdgeShapes.INNER),
    ...
    FRAMED_STACKED_CORNER_SLOPE_EDGE                ( true, false,  true,  true,  true,  true, false, ConTexMode.FULL_EDGE, Outline.CUSTOM, ElevatedCornerSlopeEdgeShapes.OUTER),
    FRAMED_STACKED_INNER_CORNER_SLOPE_EDGE          ( true, false,  true,  true,  true,  true, false, ConTexMode.FULL_FACE, Outline.CUSTOM, ElevatedCornerSlopeEdgeShapes.INNER),
    ...
    FRAMED_INNER_THREEWAY_CORNER_SLOPE_EDGE         (false, false,  true,  true,  true, false, false, ConTexMode.FULL_EDGE, Outline.CUSTOM, ThreewayCornerSlopeEdgeShapes.INNER),
    ...
    FRAMED_LARGE_CORNER_SLOPE_PANEL                 (false, false,  true,  true,  true, false, false, ConTexMode.FULL_EDGE, Outline.CUSTOM, CornerSlopePanelShapes.LARGE_OUTER),
    FRAMED_LARGE_CORNER_SLOPE_PANEL_W               (false, false,  true, false,  true, false, false, ConTexMode.FULL_EDGE, Outline.CUSTOM, new CornerSlopePanelWallShapes.LargeOuter()),
    ...
    FRAMED_LARGE_INNER_CORNER_SLOPE_PANEL           ( true, false,  true,  true,  true, false, false, ConTexMode.FULL_FACE, Outline.CUSTOM, CornerSlopePanelShapes.LARGE_INNER),
    FRAMED_LARGE_INNER_CORNER_SLOPE_PANEL_W         ( true, false,  true, false,  true, false, false, ConTexMode.FULL_FACE, Outline.CUSTOM, new CornerSlopePanelWallShapes.LargeInner()),
    ...
    FRAMED_EXT_INNER_CORNER_SLOPE_PANEL             ( true, false,  true,  true,  true, false, false, ConTexMode.FULL_FACE, Outline.CUSTOM, ExtendedCornerSlopePanelShapes.INNER),
    FRAMED_EXT_INNER_CORNER_SLOPE_PANEL_W           ( true, false,  true, false,  true, false, false, ConTexMode.FULL_FACE, Outline.CUSTOM, ExtendedCornerSlopePanelWallShapes.INNER),
    ...
    FRAMED_INV_DOUBLE_CORNER_SLOPE_PANEL            ( true, false,  true,  true,  true,  true, false, ConTexMode.FULL_EDGE, Outline.CUSTOM, new InverseDoubleCornerSlopePanelShapes()),
    FRAMED_INV_DOUBLE_CORNER_SLOPE_PANEL_W          ( true, false,  true, false,  true,  true, false, ConTexMode.FULL_EDGE, Outline.CUSTOM, new InverseDoubleCornerSlopePanelWallShapes()),
    ...
    FRAMED_STACKED_CORNER_SLOPE_PANEL               ( true, false,  true,  true,  true,  true, false, ConTexMode.FULL_EDGE, Outline.CUSTOM, ExtendedCornerSlopePanelShapes.OUTER),
    FRAMED_STACKED_CORNER_SLOPE_PANEL_W             ( true, false,  true, false,  true,  true, false, ConTexMode.FULL_EDGE, Outline.CUSTOM, ExtendedCornerSlopePanelWallShapes.OUTER),
    FRAMED_STACKED_INNER_CORNER_SLOPE_PANEL         ( true, false,  true,  true,  true,  true, false, ConTexMode.FULL_FACE, Outline.CUSTOM, ExtendedCornerSlopePanelShapes.INNER),
    FRAMED_STACKED_INNER_CORNER_SLOPE_PANEL_W       ( true, false,  true, false,  true,  true, false, ConTexMode.FULL_FACE, Outline.CUSTOM, ExtendedCornerSlopePanelWallShapes.INNER),
