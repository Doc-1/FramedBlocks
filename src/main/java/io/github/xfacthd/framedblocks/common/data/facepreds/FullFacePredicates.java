...
import io.github.xfacthd.framedblocks.common.data.facepreds.door.*;
import io.github.xfacthd.framedblocks.common.data.facepreds.misc.*;
import io.github.xfacthd.framedblocks.common.data.facepreds.prism.*;
import io.github.xfacthd.framedblocks.common.data.facepreds.slope.*;
import io.github.xfacthd.framedblocks.common.data.facepreds.slopeedge.*;
import io.github.xfacthd.framedblocks.common.data.facepreds.slopepanel.*;
import io.github.xfacthd.framedblocks.common.data.facepreds.slopepanelcorner.*;
import io.github.xfacthd.framedblocks.common.data.facepreds.slopeslab.*;
...
public final class FullFacePredicates extends BlockTypeMap<FullFacePredicate>
{
    ...
    protected void fill()
    {
        ...
        put(BlockType.FRAMED_ELEV_DOUBLE_CORNER_SLOPE_EDGE, CornerFullFacePredicate.INSTANCE);
        put(BlockType.FRAMED_ELEV_DOUBLE_INNER_CORNER_SLOPE_EDGE, InnerCornerFullFacePredicate.INSTANCE);
        put(BlockType.FRAMED_STACKED_CORNER_SLOPE_EDGE, CornerFullFacePredicate.INSTANCE);
        put(BlockType.FRAMED_STACKED_INNER_CORNER_SLOPE_EDGE, InnerCornerFullFacePredicate.INSTANCE);
        put(BlockType.FRAMED_THREEWAY_CORNER_SLOPE_EDGE, FullFacePredicate.FALSE);
        put(BlockType.FRAMED_INNER_THREEWAY_CORNER_SLOPE_EDGE, FullFacePredicate.FALSE);
        put(BlockType.FRAMED_SLOPE_EDGE_SLAB, SlopeSlabFullFacePredicate.INSTANCE);
        put(BlockType.FRAMED_SLOPE_EDGE_PANEL, SlopePanelFullFacePredicate.INSTANCE);
        ...
        put(BlockType.FRAMED_ADJ_DOUBLE_COPYCAT_SLAB, FullFacePredicate.Y_AXIS);
