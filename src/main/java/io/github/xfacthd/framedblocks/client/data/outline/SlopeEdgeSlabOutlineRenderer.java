...
public final class SlopeEdgeSlabOutlineRenderer implements SimpleOutlineRenderer
{
    @Override
    public void draw(BlockState state, LineDrawer drawer)
    {
        ...
        drawer.drawLine(1, .5F, .5F, 1, .5F,   1);

        //Slope
        drawer.drawLine(0, 0, 0, 0, .5F, .5F);
        drawer.drawLine(1, 0, 0, 1, .5F, .5F);
    }
