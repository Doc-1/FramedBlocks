...
{
    public static final ThreewayCornerSkipPredicate INSTANCE = new ThreewayCornerSkipPredicate();

    private ThreewayCornerSkipPredicate() { }
    ...
    )
    {
        ...
        return SlopeDirs.ThreewayCorner.getTriDir(dir, top, side).isEqualTo(SlopeDirs.ThreewayCorner.getTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopeDirs.ThreewayCorner.getTriDir(dir, top, side).isEqualTo(SlopeDirs.Slope.getTriDir(adjDir, adjType, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopeDirs.ThreewayCorner.getTriDir(dir, top, side).isEqualTo(SlopeDirs.HalfSlope.getTriDir(adjDir, adjTop, adjRight, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopeDirs.ThreewayCorner.getTriDir(dir, top, side).isEqualTo(SlopeDirs.VerticalHalfSlope.getTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopeDirs.ThreewayCorner.getTriDir(dir, top, side).isEqualTo(SlopeDirs.Corner.getTriDir(adjDir, adjType, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopeDirs.ThreewayCorner.getTriDir(dir, top, side).isEqualTo(SlopeDirs.InnerCorner.getTriDir(adjDir, adjType, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopeDirs.ThreewayCorner.getTriDir(dir, top, side).isEqualTo(SlopeDirs.InnerThreewayCorner.getTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopeDirs.ThreewayCorner.getTriDir(dir, top, side).isEqualTo(StairsDirs.SlopedStairs.getTriDir(adjDir, adjTop, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopeDirs.ThreewayCorner.getTriDir(dir, top, side).isEqualTo(StairsDirs.VerticalSlopedStairs.getTriDir(adjDir, adjRot, side.getOpposite()));
    }
    ...
    )
    {
        ...
        return SlopeDirs.ThreewayCorner.getTriDir(dir, top, side).isEqualTo(SlopeDirs.RailSlope.getTriDir(adjDir, side.getOpposite()));
    }
}
