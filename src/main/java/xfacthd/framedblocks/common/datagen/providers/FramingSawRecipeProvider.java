...
public final class FramingSawRecipeProvider extends RecipeProvider
{
    ...
    protected void buildRecipes(RecipeOutput consumer)
    {
        ...
        FramingSawRecipeBuilder.builder(FBContent.BLOCK_FRAMED_PILLAR_SOCKET)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE / 8 * 5)
                .save(consumer);

        FramingSawRecipeBuilder.builder(FBContent.BLOCK_FRAMED_SPLIT_PILLAR_SOCKET)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE / 8 * 5)
                .save(consumer);
        ...
        FramingSawRecipeBuilder.builder(FBContent.BLOCK_FRAMED_LAYERED_CUBE)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE / 8)
                .save(consumer);

        FramingSawRecipeBuilder.builder(FBContent.BLOCK_FRAMED_LIGHTNING_ROD)
                .material(FramingSawRecipe.CUBE_MATERIAL_VALUE / 16)
