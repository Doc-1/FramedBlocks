...
public final class SlopedPrismShapes implements SplitShapeGenerator
{
    ...
    private static ShapeProvider generate(List<BlockState> states, ShapeCache<SlopeType> slopeShapes)
    {
