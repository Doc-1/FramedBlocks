...
public enum BlockType implements IBlockType
{
    ...
    FRAMED_ELEV_DOUBLE_CORNER_SLOPE_EDGE            ( true, false,  true, false,  true,  true,  true, false, ConTexMode.FULL_EDGE, Shapes.block()),
    FRAMED_ELEV_DOUBLE_INNER_CORNER_SLOPE_EDGE      ( true, false,  true, false,  true,  true,  true, false, ConTexMode.FULL_FACE, Shapes.block()),
    FRAMED_STACKED_CORNER_SLOPE_EDGE                ( true,  true, false,  true,  true,  true,  true, false, ConTexMode.FULL_EDGE, ElevatedCornerSlopeEdgeShapes.OUTER),
    FRAMED_STACKED_INNER_CORNER_SLOPE_EDGE          ( true,  true, false,  true,  true,  true,  true, false, ConTexMode.FULL_FACE, ElevatedCornerSlopeEdgeShapes.INNER),
    FRAMED_THREEWAY_CORNER_SLOPE_EDGE               (false,  true, false,  true,  true,  true, false, false, ConTexMode.DETAILED, ThreewayCornerSlopeEdgeShapes.OUTER),
    FRAMED_INNER_THREEWAY_CORNER_SLOPE_EDGE         (false,  true, false,  true,  true,  true, false, false, ConTexMode.FULL_EDGE, ThreewayCornerSlopeEdgeShapes.INNER),
    FRAMED_SLOPE_EDGE_SLAB                          ( true,  true, false,  true,  true,  true, false, false, ConTexMode.FULL_FACE, new SlopeEdgeSlabShapes()),
    FRAMED_SLOPE_EDGE_PANEL                         ( true,  true, false,  true,  true,  true, false, false, ConTexMode.FULL_FACE, new SlopeEdgePanelShapes()),
    ...
    FRAMED_SLOPED_STAIRS                            ( true,  true, false,  true,  true,  true, false, false, ConTexMode.FULL_FACE, SlopedStairsShapes.INSTANCE),
    FRAMED_SLOPED_DOUBLE_STAIRS                     ( true, false,  true, false,  true,  true,  true, false, ConTexMode.FULL_FACE, Shapes.block()),
    FRAMED_SLICED_SLOPED_STAIRS_SLAB                ( true,  true,  true,  true,  true,  true,  true, false, ConTexMode.FULL_FACE, SlopedStairsShapes.INSTANCE),
    FRAMED_SLICED_SLOPED_STAIRS_SLOPE               ( true,  true,  true,  true,  true,  true,  true, false, ConTexMode.FULL_FACE, SlopedStairsShapes.INSTANCE),
    ...
    FRAMED_VERTICAL_SLOPED_STAIRS                   ( true,  true, false,  true,  true,  true, false, false, ConTexMode.FULL_FACE, VerticalSlopedStairsShapes.INSTANCE),
    FRAMED_VERTICAL_SLOPED_DOUBLE_STAIRS            ( true, false,  true, false,  true,  true,  true, false, ConTexMode.FULL_FACE, Shapes.block()),
    FRAMED_VERTICAL_SLICED_SLOPED_STAIRS_PANEL      ( true,  true,  true,  true,  true,  true,  true, false, ConTexMode.FULL_FACE, VerticalSlopedStairsShapes.INSTANCE),
    ...
    FRAMED_COPPER_TORCH                             (false, false, false, false,  true, false, false, false, null),
    FRAMED_COPPER_WALL_TORCH                        (false, false, false, false, false, false, false, false, null),
    ...
    FRAMED_BOARD                                    ( true, false, false,  true,  true,  true, false, false, ConTexMode.FULL_FACE, BoardShapes::generate),
    ...
    FRAMED_CHEST                                    (false, false,  true,  true,  true, false, false, false, ConTexMode.DETAILED, ChestShapes::generate),
    ...
    FRAMED_PILLAR_SOCKET                            ( true, false, false,  true,  true,  true, false, false, ConTexMode.FULL_FACE, PillarSocketShapes::generate),
    FRAMED_SPLIT_PILLAR_SOCKET                      ( true, false, false,  true,  true,  true,  true, false, ConTexMode.FULL_FACE, PillarSocketShapes::generate),
    ...
    FRAMED_CORNER_TUBE                              ( true, false, false,  true,  true, false, false, false, ConTexMode.FULL_FACE, CornerTubeShapes::generate),
    ...
    FRAMED_COPPER_LANTERN                           (false, false, false,  true,  true, false, false, false, null),
