package xfacthd.framedblocks.client.model.geometry.slopeedge.legacy;
...
public class LegacyFramedInnerCornerSlopeEdgeGeometry extends Geometry
{
    ...
    public LegacyFramedInnerCornerSlopeEdgeGeometry(GeometryFactory.Context ctx)
    {
