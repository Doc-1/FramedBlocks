...
public final class FramedLanguageProvider extends LanguageProvider
{
    ...
    private void addFramedBlockTranslations()
    {
        ...
        add(FBContent.BLOCK_FRAMED_SLOPE_EDGE.get(), "Framed Slope Edge");
        add(FBContent.BLOCK_FRAMED_ELEVATED_SLOPE_EDGE.get(), "Framed Elevated Slope Edge");
        add(FBContent.BLOCK_FRAMED_ELEVATED_DOUBLE_SLOPE_EDGE.get(), "Framed Elevated Double Slope Edge");
        add(FBContent.BLOCK_FRAMED_STACKED_SLOPE_EDGE.get(), "Framed Stacked Slope Edge");
        ...
        add(FBContent.BLOCK_FRAMED_MASONRY_CORNER_SEGMENT.get(), "Framed Masonry Corner Segment");
        add(FBContent.BLOCK_FRAMED_MASONRY_CORNER.get(), "Framed Masonry Corner");
        add(FBContent.BLOCK_FRAMED_STAIRS.get(), "Framed Stairs");
        add(FBContent.BLOCK_FRAMED_THREEWAY_CORNER_PILLAR.get(), "Framed Threeway Corner Pillar");
        add(FBContent.BLOCK_FRAMED_DOUBLE_THREEWAY_CORNER_PILLAR.get(), "Framed Double Threeway Corner Pillar");
        ...
        add(FBContent.BLOCK_FRAMED_SLICED_STAIRS_SLAB.get(), "Framed Sliced Stairs (Slab)");
        add(FBContent.BLOCK_FRAMED_SLICED_STAIRS_PANEL.get(), "Framed Sliced Stairs (Panel)");
        ...
        add(FBContent.BLOCK_FRAMED_COMPOUND_SLOPE_SLAB.get(), "Framed Compound Slope Slab");
        ...
        add(FBContent.BLOCK_FRAMED_VERTICAL_DOUBLE_HALF_STAIRS.get(), "Framed Vertical Double Half Stairs");
        add(FBContent.BLOCK_FRAMED_VERTICAL_SLICED_STAIRS.get(), "Framed Vertical Sliced Stairs");
        ...
        add(FBContent.BLOCK_FRAMED_COMPOUND_SLOPE_PANEL.get(), "Framed Compound Slope Panel");
        ...
        add(FBContent.BLOCK_FRAMED_SMALL_CORNER_SLOPE_PANEL.get(), "Framed Small Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_SMALL_CORNER_SLOPE_PANEL_WALL.get(), "Framed Small Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_LARGE_CORNER_SLOPE_PANEL.get(), "Framed Large Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_LARGE_CORNER_SLOPE_PANEL_WALL.get(), "Framed Large Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_SMALL_INNER_CORNER_SLOPE_PANEL.get(), "Framed Small Inner Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_SMALL_INNER_CORNER_SLOPE_PANEL_WALL.get(), "Framed Small Inner Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_LARGE_INNER_CORNER_SLOPE_PANEL.get(), "Framed Large Inner Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_LARGE_INNER_CORNER_SLOPE_PANEL_WALL.get(), "Framed Large Inner Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_SMALL_DOUBLE_CORNER_SLOPE_PANEL.get(), "Framed Small Double Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_SMALL_DOUBLE_CORNER_SLOPE_PANEL_WALL.get(), "Framed Small Double Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_LARGE_DOUBLE_CORNER_SLOPE_PANEL.get(), "Framed Large Double Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_LARGE_DOUBLE_CORNER_SLOPE_PANEL_WALL.get(), "Framed Large Double Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_INVERSE_DOUBLE_CORNER_SLOPE_PANEL.get(), "Framed Inverse Double Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_INVERSE_DOUBLE_CORNER_SLOPE_PANEL_WALL.get(), "Framed Inverse Double Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_EXTENDED_CORNER_SLOPE_PANEL.get(), "Framed Extended Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_EXTENDED_CORNER_SLOPE_PANEL_WALL.get(), "Framed Extended Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_EXTENDED_INNER_CORNER_SLOPE_PANEL.get(), "Framed Extended Inner Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_EXTENDED_INNER_CORNER_SLOPE_PANEL_WALL.get(), "Framed Extended Inner Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_EXTENDED_DOUBLE_CORNER_SLOPE_PANEL.get(), "Framed Extended Double Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_EXTENDED_DOUBLE_CORNER_SLOPE_PANEL_WALL.get(), "Framed Extended Double Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_EXTENDED_INNER_DOUBLE_CORNER_SLOPE_PANEL.get(), "Framed Extended Inner Double Slope Panel Corner");
        add(FBContent.BLOCK_FRAMED_EXTENDED_INNER_DOUBLE_CORNER_SLOPE_PANEL_WALL.get(), "Framed Extended Inner Double Slope Panel Corner");
        add(FBContent.BLOCK_FRAMED_STACKED_CORNER_SLOPE_PANEL.get(), "Framed Stacked Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_STACKED_CORNER_SLOPE_PANEL_WALL.get(), "Framed Stacked Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_STACKED_INNER_CORNER_SLOPE_PANEL.get(), "Framed Stacked Inner Corner Slope Panel");
        add(FBContent.BLOCK_FRAMED_STACKED_INNER_CORNER_SLOPE_PANEL_WALL.get(), "Framed Stacked Inner Corner Slope Panel");
        ...
        add(FBContent.BLOCK_FRAMED_CORNER_STRIP.get(), "Framed Corner Strip");
        ...
        add(FBContent.BLOCK_FRAMED_CHECKERED_CUBE_SEGMENT.get(), "Framed Checkered Cube Segment");
        add(FBContent.BLOCK_FRAMED_CHECKERED_CUBE.get(), "Framed Checkered Cube");
        add(FBContent.BLOCK_FRAMED_CHECKERED_SLAB_SEGMENT.get(), "Framed Checkered Slab Segment");
        add(FBContent.BLOCK_FRAMED_CHECKERED_SLAB.get(), "Framed Checkered Slab");
        add(FBContent.BLOCK_FRAMED_CHECKERED_PANEL_SEGMENT.get(), "Framed Checkered Panel Segment");
        add(FBContent.BLOCK_FRAMED_CHECKERED_PANEL.get(), "Framed Checkered Panel");
        add(FBContent.BLOCK_FRAMED_TUBE.get(), "Framed Tube");
    }
